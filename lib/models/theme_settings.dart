...
class ThemeSettings extends ChangeNotifier {
  ...
  static const Map<String, Map<String, Color>> presets = {
    ...
    // マルチカラー系テーマ
    'ロマンチック': {
      'appBarColor': Color(0xFF69113C), // 深いワインレッド
      'backgroundColor': Color(0xFFFFE9DC), // 薄いピーチ
      'buttonColor': Color(0xFF69113C), // 深いワインレッド（メインカラー）
      'appButtonColor': Color(0xFF69113C),
      'cardBackgroundColor': Color(0xFFFFFFFF),
      'fontColor1': Color(0xFF000000),
      'fontColor2': Color(0xFFFFFFFF),
      'timerCircleColor': Color(0xFFD7D2DE),
      'bottomNavigationColor': Color(0xFF69113C),
      'inputBackgroundColor': Color(0xFFFFF5F0),
      'iconColor': Color(0xFFEBB4B2), // ピンクベージュ
      'memberBackgroundColor': Color(0xFFFFE9DC),
      'appBarTextColor': Color(0xFFFFFFFF),
      'bottomNavigationTextColor': Color(0xFFFFFFFF),
      'dialogBackgroundColor': Color(0xFFFFFFFF),
      'dialogTextColor': Color(0xFF000000),
      'inputTextColor': Color(0xFF000000),
      'borderColor': Color(0xFFE0E0E0),
      'bottomNavigationSelectedColor': Color(0xFFEBB4B2),
      'bottomNavigationUnselectedColor': Color(0xFFD7D2DE),
      'settingsColor': Color(0xFF69113C),
      'calculatorColor': Color(0xFFEBB4B2),
      'todoColor': Color(0xFFEBB4B2),
      'tastingColor': Color(0xFFD84315),
    },
    'おしゃれ': {
      'appBarColor': Color(0xFF000000), // 黒
      'backgroundColor': Color(0xFFFFFFFF), // 白
      'buttonColor': Color(0xFFFF006F), // ビビッドピンク（ボタン色のみ変更）
      'appButtonColor': Color(0xFFFF006F),
      'cardBackgroundColor': Color(0xFFFFFFFF),
      'fontColor1': Color(0xFF000000),
      'fontColor2': Color(0xFFFFFFFF),
      'timerCircleColor': Color(0xFFFF006F),
      'bottomNavigationColor': Color(0xFF000000),
      'inputBackgroundColor': Color(0xFFFAFAFA),
      'iconColor': Color(0xFFFFBF1F), // ゴールドイエロー
      'memberBackgroundColor': Color(0xFFF5F5F5),
      'appBarTextColor': Color(0xFFFFFFFF),
      'bottomNavigationTextColor': Color(0xFFFFFFFF),
      'dialogBackgroundColor': Color(0xFFFFFFFF),
      'dialogTextColor': Color(0xFF000000),
      'inputTextColor': Color(0xFF000000),
      'borderColor': Color(0xFFE0E0E0),
      'bottomNavigationSelectedColor': Color(0xFFFFBF1F),
      'bottomNavigationUnselectedColor': Color(0xFF9E9E9E),
      'settingsColor': Color(0xFF000000),
      'calculatorColor': Color(0xFFFFBF1F),
      'todoColor': Color(0xFFFFBF1F),
      'tastingColor': Color(0xFFD84315),
    },
    '清潔感': {
      'appBarColor': Color(0xFF009BC6), // ディープブルー
      'backgroundColor': Color(0xFFFFFFFF), // 白
      'buttonColor': Color(0xFF009BC6), // ディープブルー（メインカラー）
      'appButtonColor': Color(0xFF009BC6),
      'cardBackgroundColor': Color(0xFFFFFFFF),
      'fontColor1': Color(0xFF000000),
      'fontColor2': Color(0xFFFFFFFF),
      'timerCircleColor': Color(0xFF7ACBE1),
      'bottomNavigationColor': Color(0xFF009BC6),
      'inputBackgroundColor': Color(0xFFF5F9FA),
      'iconColor': Color(0xFF99CC65), // ライトグリーン
      'memberBackgroundColor': Color(0xFFF0F8FF),
      'appBarTextColor': Color(0xFFFFFFFF),
      'bottomNavigationTextColor': Color(0xFFFFFFFF),
      'dialogBackgroundColor': Color(0xFFFFFFFF),
      'dialogTextColor': Color(0xFF000000),
      'inputTextColor': Color(0xFF000000),
      'borderColor': Color(0xFFE0E0E0),
      'bottomNavigationSelectedColor': Color(0xFF99CC65),
      'bottomNavigationUnselectedColor': Color(0xFF9E9E9E),
      'settingsColor': Color(0xFF009BC6),
      'calculatorColor': Color(0xFF99CC65),
      'todoColor': Color(0xFF99CC65),
      'tastingColor': Color(0xFFD84315),
    },
    '高級': {
      'appBarColor': Color(0xFF000000), // 黒
      'backgroundColor': Color(0xFFEDDCBC), // ベージュゴールド
      'buttonColor': Color(0xFF000000), // 黒（メインカラー）
      'appButtonColor': Color(0xFF000000),
      'cardBackgroundColor': Color(0xFFFFFFFF), // 白
      'fontColor1': Color(0xFF000000),
      'fontColor2': Color(0xFFFFFFFF),
      'timerCircleColor': Color(0xFFB0941E), // ダークゴールド
      'bottomNavigationColor': Color(0xFF000000),
      'inputBackgroundColor': Color(0xFFF5F0E8),
      'iconColor': Color(0xFFEED13F), // ブライトゴールド
      'memberBackgroundColor': Color(0xFFF8F3E8),
      'appBarTextColor': Color(0xFFFFFFFF),
      'bottomNavigationTextColor': Color(0xFFFFFFFF),
      'dialogBackgroundColor': Color(0xFFFFFFFF), // 白
      'dialogTextColor': Color(0xFF000000),
      'inputTextColor': Color(0xFF000000),
      'borderColor': Color(0xFFE0E0E0),
      'bottomNavigationSelectedColor': Color(0xFFEED13F),
      'bottomNavigationUnselectedColor': Color(0xFF9E9E9E),
      'settingsColor': Color(0xFF000000),
      'calculatorColor': Color(0xFFEED13F),
      'todoColor': Color(0xFFEED13F),
      'tastingColor': Color(0xFFD84315),
    },
